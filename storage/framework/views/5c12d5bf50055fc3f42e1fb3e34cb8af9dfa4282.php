                                ...
                                <div class="media-left tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid"
                                             src="<?php echo e(asset('images/authors/img1.jpg')); ?>" alt="image">
                                    </a>
                                </div>
                            </div>
                            <p>
                        ...
                        <div class="tab-pane" id="tab_default_2">
                            <div class="media">
                                <div class="media-left media-middle tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid"
                                             src="<?php echo e(asset('images/authors/img2.jpg')); ?>" alt="image">
                                    </a>
                                </div>
                            </div>
                            <p>
                        ...
                        <div class="tab-pane" id="tab_default_3">
                            <div class="media">
                                <div class="media-left media-middle tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid"
                                             src="<?php echo e(asset('images/authors/img3.jpg')); ?>" alt="image">
                                    </a>
                                </div>
                            </div>
                            <p>
                        ...
                        <div class="tab-pane" id="tab_default_4">
                            <div class="media">
                                <div class="media-left media-middle tab col-sm-12">
                                    <a href="#">
                                        <img class="media-object img-fluid"
                                             src="<?php echo e(asset('images/authors/img4.jpg')); ?>" alt="image">
                                    </a>
                                </div>
                            </div>
                            <p>
