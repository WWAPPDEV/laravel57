                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="<?php echo e(route('signin')); ?>" autocomplete="on" method="post" role="form" id="login_form" class="my-3">
                                <h3 class="black_bg">
                                ...
                                <div class="col-lg-12 text-center social_login m-t-10 mb-3">
                                    <a class="btn btn-block btn-social btn-facebook" href="<?php echo e(url('/facebook')); ?>">
                                        <i class="fa fa-facebook"></i> Sign in with Facebook
                                    </a>
                                    <a class="btn btn-block btn-social btn-google-plus" href="<?php echo e(url('/google')); ?>">
                                        <i class="fa fa-google-plus"></i> Sign in with Google
                                    </a>
                                    <a class="btn btn-block btn-social btn-linkedin" href="<?php echo e(url('/linkedin')); ?>">
