...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/frontend/cart.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/font-awesome.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/frontend/tabbular.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendors/bootstrap-rating/bootstrap-rating.css')); ?>">
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container my-3">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-12">
                    <div class="row">
                        <div class="product_wrapper">
                            <img id="zoom_09" src="<?php echo e(asset('images/cart/small/1.jpg')); ?>" data-zoom-image="<?php echo e(asset('images/cart/big/1.jpg')); ?>" class="img-fluid" />
                        </div>
                    </div>
                    <div class="row">
                        <!--individual products in product view-->
                        <div id="gal1">
                            <a href="#" data-image="<?php echo e(asset('images/cart/small/1.jpg')); ?>" data-zoom-image="<?php echo e(asset('images/cart/big/1.jpg')); ?>">
                                <img id="img_01" src="<?php echo e(asset('images/cart/small/1.jpg')); ?>" class="img-fluid" />
                            </a>
                            <a href="#" data-image="<?php echo e(asset('images/cart/small/2.jpg')); ?>" data-zoom-image="<?php echo e(asset('images/cart/big/2.jpg')); ?>">
                                <img id="img_01" src="<?php echo e(asset('images/cart/small/2.jpg')); ?>" class="img-fluid" />
                            </a>
                            <a href="#" data-image="<?php echo e(asset('images/cart/small/3.jpg')); ?>" data-zoom-image="<?php echo e(asset('images/cart/big/3.jpg')); ?>">
                                <img id="img_01" src="<?php echo e(asset('images/cart/small/3.jpg')); ?>" class="img-fluid" />
                            </a>
                            <a href="#" data-image="<?php echo e(asset('images/cart/small/4.jpg')); ?>" data-zoom-image="<?php echo e(asset('images/cart/big/4.jpg')); ?>">
                                <img id="img_01" src="<?php echo e(asset('images/cart/small/4.jpg')); ?>" class="img-fluid" />
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="flip-3d">
                <figure>
                    <img src="<?php echo e(asset('images/cart/default/saree1.jpg')); ?>" alt="product image" class="img-fluid">
                    <figcaption>
            ...
            <div class="flip-3d">
                <figure>
                    <img src="<?php echo e(asset('images/cart/default/shirt.jpg')); ?>" alt="product image" class="img-fluid">
                    <figcaption>
            ...
            <div class="flip-3d">
                <figure>
                    <img src="<?php echo e(asset('images/cart/default/sony.jpg')); ?>" alt="product image" class="img-fluid">
                    <figcaption>
            ...
            <div class="flip-3d">
                <figure>
                    <img src="<?php echo e(asset('images/cart/default/samsung.jpg')); ?>" alt="product image" class="img-fluid">
                    <figcaption>
...
<?php $__env->startSection('footer_scripts'); ?>
    <!--page level js start-->
    <script type="text/javascript" src="<?php echo e(asset('js/frontend/elevatezoom.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('vendors/bootstrap-rating/bootstrap-rating.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('js/frontend/cart.js')); ?>"></script>
    <!--page level js start-->
