<li class="dropdown messages-menu ">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenuLink" aria-haspopup="true" aria-expanded="false"> <i class="livicon"
                                                                   ...
                                                                   data-size="28"></i>
        <?php if($count>0): ?>
        <span class="label label-success"><?php echo e($count); ?></span>
            <?php endif; ?>
    </a>
        ...
        <?php endif; ?>
            <?php if(isset($notifications)): ?>
                <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(\App\User::where('id',$notification->user_id)->exists()): ?>
                    <li class="unread message dropdown-item">
                        <a href="<?php echo e(URL::to('admin/emails/'.$notification->id )); ?>" class="message"> <i class="pull-right" data-toggle="tooltip"
